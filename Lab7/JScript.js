    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4 && req.status == 200) {
            ...
            for(item of response.data){
                ...
                imgElem.src = item.link;const clientId = "ae46f54c86c85c3";
                ...
                function requestAlbumXHR() {
                    ...
                    req.open('GET', 'http://api.weatherapi.com/v1/current.json?key=51236aca09894253905162316231705&q=&aqi=n' + albumId + '/images', true); // true for asynchronous     
                ...
                function fetchGiphyAPI_UsingFetch(keyword) {
                    ...
                    var url = "http://api.weatherapi.com/v1/current.json?key=51236aca09894253905162316231705&q=&aqi=n";
                    var apiKey = "????????????????";
